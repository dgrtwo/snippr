...
To share your snippets, create a GitHub repository with one or more `.snippets` file at the top level: see [here](https://github.com/dgrtwo/snippets) for an example. (You can have other files or folders in the repository, such as a `README.md`, and they will be skipped).
